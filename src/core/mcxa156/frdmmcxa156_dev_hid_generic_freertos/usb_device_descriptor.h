...
#define USB_HID_GENERIC_OUT_BUFFER_LENGTH (64U)  // Updated for FIDO2
...
#define HS_HID_GENERIC_INTERRUPT_OUT_PACKET_SIZE (64U)  // Updated for FIDO2
#define FS_HID_GENERIC_INTERRUPT_OUT_PACKET_SIZE (64U)  // Updated for FIDO2
#define HS_HID_GENERIC_INTERRUPT_OUT_INTERVAL    (0x04U) /* 2^(4-1) = 1ms */
#define FS_HID_GENERIC_INTERRUPT_OUT_INTERVAL    (0x01U)

#define HS_HID_GENERIC_INTERRUPT_IN_PACKET_SIZE (64U)  // Updated for FIDO2
#define FS_HID_GENERIC_INTERRUPT_IN_PACKET_SIZE (64U)  // Updated for FIDO2
